...
public class UnoCardTest {
  ...
  public void setUp() throws Exception {
    ...
    star = CardFactory.createCard(Color.BLUE, Symbol.STAR);
    superstar = CardFactory.createCard(Color.NONE, Symbol.SUPERSTAR);
  ...
  public void testPlayableOver() {
    ...
    assertTrue(star.isPlayableOver(blue4));
    assertTrue(superstar.isPlayableOver(wild));
  }
  ...
  public void testIsFirstPlayable() {
    ...
    assertFalse(wild4.isFirstPlayable());
    assertTrue(star.isFirstPlayable());
  } 
  
  @Test
  public void testString() {
    assertEquals("4 blue", blue4.toString());
    assertEquals("wild none", wild.toString());
  }
